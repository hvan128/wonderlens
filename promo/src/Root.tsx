...
import { CUP_JOURNEY_DURATION_IN_FRAMES, WonderLensCupJourneyPromo } from './WonderLensCupJourneyPromo';
import { CUP_UI_DURATION_IN_FRAMES, WonderLensCupUiPromo } from './WonderLensCupUiPromo';
import { CUP_WOW_DURATION_IN_FRAMES, WonderLensCupWowPromo } from './WonderLensCupWowPromo';
import { ORBIT_DURATION_IN_FRAMES, WonderLensOrbitPromo } from './WonderLensOrbitPromo';
